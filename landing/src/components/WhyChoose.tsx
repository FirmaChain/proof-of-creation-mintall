...
const WhyChoose: React.FC = () => {
  ...
  return (
    <section id="why-choose" className="py-20 bg-white" ref={ref}>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="px-8 py-3 bg-white text-primary-700 rounded-lg font-semibold hover:bg-gray-100 transition-all inline-block text-center"
            >
              Read About Proof of Creation
            </a>
            <a
              href="https://t.me/firmachain_global"
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 py-3 bg-white/20 text-white rounded-lg font-semibold hover:bg-white/30 transition-all inline-block text-center"
            >

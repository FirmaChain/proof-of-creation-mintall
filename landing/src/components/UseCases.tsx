        ...
        >
          <div className="max-w-4xl mx-auto bg-gradient-to-r from-primary-50 to-blue-50 rounded-2xl p-8 lg:p-12 text-center">
            ...
            <p className="text-gray-700 max-w-2xl mx-auto">
              Proof of Creation is currently integrated with Mintall, the creative platform
              serving real users in Silicon Valley. Experience the future of digital authenticity today.
            </p>
            <a
              href="https://www.mintall.ai/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block mt-6 px-6 py-3 bg-gradient-to-r from-primary-600 to-primary-700 text-white rounded-lg font-semibold hover:from-primary-700 hover:to-primary-800 transition-all transform hover:scale-105"
            >
              Try Mintall
            </a>
          </div>
